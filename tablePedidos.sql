-- Active: 1728553408593@@127.0.0.1@5432@cursonosql
/**
*? Comandos NoSQL para a definição da estrutura de tabelas chave-valor com JSON
*/

CREATE DATABASE CursoNoSQL;

/**
** criação da tabela com o atributo JSON 
*/
...
/**
** Uma observação é que não se pode usar o distinct e order by sobre o campo JSON.
** Assim, necessita-se transformar para texto com o operador “ ->> ”
*/

SELECT distinct detalhes ->> 'cliente' AS cliente
FROM pedidos order by 1 ;

/**
** Esse operador também pode ser usado para gerar a listagem apresentando os pedidos feitos pela cliente de nome igual a ‘Ana’.ADD
*/
SELECT * FROM pedidos
...
/**
** vamos verificar como incluir itens em um pedido usando vetores (arrays) em JSON.
*/
INSERT INTO pedidos(detalhes) VALUES
( '{"cliente": "Nei","itens": [
...
/**
**  acessar cada elemento do array por meio de seu índice, que tem o valor iniciado em zero:
*/
...
** Esse tipo de consulta permite confirmar os tipos de dados usados e dessa forma avaliar
** o operador JSON adequado às respostas necessárias.
*/
